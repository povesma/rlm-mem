...
### Step 7: Save to Claude-Mem and File
...
Then Read the file you just created. The PostToolUse hook captures the full
content as a claude-mem observation automatically.
...
7. Save to file, then Read the file — hook auto-captures it to claude-mem
